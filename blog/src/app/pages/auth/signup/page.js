      ...
      <div className="flex justify-between w-full items-center">
        <div className="mx-auto xl:mt-0 my-10 ">
          <form onSubmit={handleSubmit} className="signup__form text-white flex flex-col">
              <div className="pb-3">
                <h1 className='text-white text-4xl lg:text-5xl font-semibold'> Create New Account  </h1>
              </div>
              <div className="">
                <p className='lg:text-lg text-gray-400 pb-6'> Fill in all the details to create a new account </p>
              </div>
              ...
              <button className="signUp__button w-1/2 p-2 self-center  rounded-lg border-white border-2 text-white font-bold mb-2 py-3 hover:bg-white hover:text-black transition-all delay-75" type="submit"> 
                  Register 
              </button>
              <div className=" self-center">
              <p className='text-gray-400'> Already have an account ? <Link href='/pages/auth/signin' className='text-gray-300 hover:text-white'> Sign In </Link> </p>
              </div>
          </form>
        </div>
